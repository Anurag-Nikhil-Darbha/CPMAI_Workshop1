...
- `.design-systems/specs/[this-spec]/spec.md` (if present)
- `.design-systems/specs/[this-spec]/planning/requirements.md` (if present)
- `.design-systems/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `.design-systems/specs/[this-spec]/tasks.md`
