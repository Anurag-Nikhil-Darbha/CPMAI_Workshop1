...
cat .design-systems/specs/[current-spec]/planning/requirements.md

# Check for visual assets
ls -la .design-systems/specs/[current-spec]/planning/visuals/ 2>/dev/null | grep -v "^total" | grep -v "^d"
```
...
Write the main specification to `.design-systems/specs/[current-spec]/spec.md`.
