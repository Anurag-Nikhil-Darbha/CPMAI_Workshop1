...
Read `.design-systems/specs/[this-spec]/planning/requirements.md` and verify:
...
1. **Read each visual file** in `.design-systems/specs/[this-spec]/planning/visuals/`
...
3. **Verify these design elements appear in**:
   - `.design-systems/specs/[this-spec]/spec.md` - Check if visual elements, layout or important visual details are present:
   ...
   - `.design-systems/specs/[this-spec]/tasks.md` - Confirm at least some tasks specifically reference:
     * Visual file names
     * Components shown in visuals
     * Layouts depicted in mockups

#### Check 4: Requirements Deep Dive
Read `.design-systems/specs/[this-spec]/planning/requirements.md` and create a mental list of:
...
Read `.design-systems/specs/[this-spec]/spec.md` and verify each section:
...
Read `.design-systems/specs/[this-spec]/tasks.md` and check each task group's tasks:
...
Create `.design-systems/specs/[this-spec]/verification/spec-verification.md` with the following structure:
...
See .design-systems/specs/[this-spec]/verification/spec-verification.md for full details.
```
...
@.design-systems/standards/backend/api.md
@.design-systems/standards/backend/migrations.md
@.design-systems/standards/backend/models.md
@.design-systems/standards/backend/queries.md
@.design-systems/standards/frontend/accessibility.md
@.design-systems/standards/frontend/components.md
...
@.design-systems/standards/global/commenting.md
@.design-systems/standards/global/conventions.md
@.design-systems/standards/global/error-handling.md
@.design-systems/standards/global/tech-stack.md
@.design-systems/standards/global/validation.md
@.design-systems/standards/testing/test-writing.md
